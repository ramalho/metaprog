...
iter_memo = memoize(fatorial.iterativo)
recur_memo = memoize(fatorial.recursivo)

for fn in [fatorial.recursivo, fatorial.iterativo, iter_memo, recur_memo]:
...
cronometrar(recur_memo)
cronometrar(iter_memo)
